...
Public Class pembelian
    ...
    Sub isiCombo()
        Call koneksi()
        CD = New MySqlCommand("SELECT kodesuplier from tabel_suplier", CONN)
        DR = CD.ExecuteReader
    ...
    Sub ambilNama()
        Call koneksi()
        CD = New MySqlCommand("SELECT namasuplier from tabel_suplier where kodesuplier = '" & ComboBox1.Text & "'", CONN)
        DR = CD.ExecuteReader
        DR.Read()
        If DR.HasRows Then
            txnamasup.Text = DR.Item(0)
        End If
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Call koneksi()
            simpan = "INSERT INTO tabel_beli (nofak,tanggal,kodesuplier,totalitem,totalbayar) VALUE (@P1,@P2,@P3,@P4,@P5)"
            simpan1 = "INSERT INTO tabel_detailbeli (nofak,kodebarang,jumlah) VALUE (@P6,@P7,@P8)"
            ...
            With CD
                ...
                .Parameters.Add("p4", MySqlDbType.Int32).Value = txttotal.Text
                .Parameters.Add("p5", MySqlDbType.Int32).Value = txtbayar.Text
                .ExecuteNonQuery()
            End With
